...
void main() {  
  ...
  // color of the spray defined by stroke color
  //vec4 color = vec4(vertColor.rgb, alpha);

  // color of the spray defined by sample of the movie frame at the center of the point
  vec4 color = vec4(texture2D( movieFrame, center/resolution ));
