// BUILDING SHADER
// Based on https://www.shadertoy.com/view/4ss3z4 by ztri
...
float terrain(vec3 pos){ 
    ...
    float c2 = sphere(pos+vec3(0.0,300.0+sin(myTime*0.3)*50.0,00.0),120.0)+n1*5.0*sin(myTime*2.0+pos.z*0.01);
...
void main(void){
	...
	float fog = noise2d(ray1.xy*3.0+campos.xz*0.001+vec2(0.0,-myTime*0.2));
